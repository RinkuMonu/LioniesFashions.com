        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                To celebrate our heritage, we proudly present L.B men's wear Store, a contemporary menswear brand designed for the modern lifestyle. Inspired by traditional Indian craftsmanship, L.B men's wear Store brings authentic techniques and rich heritage into stylish, modern designs.


              </p>
              <p className="text-gray-600 leading-relaxed">
               Whether you’re looking for handcrafted menswear, accessories, or curated fabrics, L.B men's wear Store blends traditional artistry with contemporary style crafted with care, made for you.
              </p>
            </div>
          </div>
          <div className="relative w-full h-[300px] rounded-2xl overflow-hidden shadow-xl">
            <img
              ...
              alt="L.B men's wear Store modern designs"
