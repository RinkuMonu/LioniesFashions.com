...
export default function ExchangeReturn() {
  ...
  <p className="text-justify text-gray-700 leading-relaxed">
    At L.B men's wear Store , we take pride in offering premium menswear crafted with care and quality. While we strive for perfection, we understand that sometimes a product may not meet your expectations. To ensure a smooth shopping experience, we offer returns, refunds, and exchanges under the following terms:
  </p>
...
• If the error is on our part (defective or incorrect item), the replacement will be free of charge. 
  ...
  <p className="text-justify text-gray-700 leading-relaxed">
    ...
    If the return is due to our mistake, L.B men's wear Store  covers the shipping costs  
  </p>
  <p className="text-justify text-gray-700 leading-relaxed">
