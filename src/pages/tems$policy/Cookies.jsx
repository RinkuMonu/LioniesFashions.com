...
//             <h1 className="section-heading"><strong>Cookie Policy for L.B men's wear Store</strong></h1>
...
//             <ul className="terms-list">
//               <li>Email: <a href="mailto:Info@Finunique Small Pvt Ltd.in">info@lioniesfashion.com</a></li>
//             </ul>
//           </div>
//         </div>
//       </section>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-6">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <div className="flex items-center justify-between bg-blue-50 rounded-lg p-4">
                    ...
                    <a 
                      href="mailto:info@lioniesfashion.com" 
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-purple-950 to-purple-300 p-6 md:p-8">
                  ...
                  <p className="text-indigo-100 mt-4 max-w-3xl">
                    This policy explains how L.B men's wear Store uses cookies and similar technologies to recognize you when you visit our websites.
                  </p>
                </div>
                  ...
                  <div id="more-info" className="scroll-mt-24">
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 mt-6">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        >
                          <span>Email: info@lioniesfashion.com</span>
                        </a>
                        <a 
                          href="/contact" 
