  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="text-md text-gray-600 text-center">
        Please read our Privacy Policy carefully before using L.B men's wear Store Mens Wear services.
      </p>
...
const privacySections = [
  ...
  },
  {
    ...
    content: [
      "While we take extensive measures to safeguard your data, we advise you not to share sensitive information with third parties claiming to be associated with L.B men's wear Store.",
