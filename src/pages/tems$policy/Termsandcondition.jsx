      ...
      {/* <div className="mt-12 text-sm text-gray-600 space-y-2 border-t border-gray-300 pt-6">
        <p>
          ...
          <span className="text-gray-700">
            L.B men's wear Store | Dabu Print | Sanganeri Print | Discharge Print | Tine And Dye Print | Black And White Print
          </span>
        </p>
        <p>
...
const termsSections = [
    ...
    },
    {
      ...
      content: [
        "We at L.B men's wear Store believe that the Debit/Credit card details provided by you to get the services from website will be correct and accurate and you will not provide any card details which are legally not owned by you.",
