        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li className="hover:text-[#cba146] transition flex items-start gap-2">
              ...
              11,12
SITA RAM COLONY, TONK ROAD,Jaipur
 Rajasthan, 302029
              </div>
            </li>
...
>
  ...
  <span className="font-medium text-white"> L.B men's wear Store</span>. 
  All rights reserved.  
  <br />
{/* 
  <span className="inline-block mt-1 text-xs text-gray-500">
    Powered by{" "}
    <span className="font-semibold text-white hover:text-pink-400 transition duration-300 cursor-pointer">
      Rahul Enterprises
    </span>
  </span> */}
</div>
